 ...
 *
 * @method bool   equals(DateTimeInterface|string $date, string $timezone = null)    Determine if date is equal to another  Date instance.
 ...
 * @method bool   gt(DateTimeInterface|string $date, string $timezone = null)        Determine if date is greater than another  Date instance.
 * @method bool   gte(DateTimeInterface|string $date, string $timezone = null)       Determine if date is greater than or equal to another  Date instance.
 * @method bool   isAfter(DateTimeInterface|string $date, string $timezone = null)   Determine if date is greater than another  Date instance.
 * @method string isAmOrPm()                                                         Determines if time is AM or PM.
 * @method bool   isBefore(DateTimeInterface|string $date, string $timezone = null)  Determine if date is less than another  Date instance.
 * @method bool   isDaylightSavings()                                                Determines if observing daylight savings.
 * @method bool   isLeapYear()                                                       Determines if is leap year.
 * @method bool   lt(DateTimeInterface|string $date, string $timezone = null)        Determine if date is less than another  Date instance.
 * @method bool   lte(DateTimeInterface|string $date, string $timezone = null)       Determine if date is less than or equal to another  Date instance.
 * @method bool   ne(DateTimeInterface|string $date, string $timezone = null)        Determine if date is not equal to another  Date instance.
 * @method bool   notEquals(DateTimeInterface|string $date, string $timezone = null) Determine if date is not equal to another  Date instance.
 *
...
class Date extends DateTime
{
     ...
     *
     * @param mixed      $date1
     * @param mixed|null $date2
     *
     * @return false|int Returns the number of years or false if invalid dates
     */
